...
func (m *SimpleSecret) Reset()                    { *m = SimpleSecret{} }
func (m *SimpleSecret) String() string            { return proto.CompactTextString(m) }
func (*SimpleSecret) ProtoMessage()               {}
func (*SimpleSecret) Descriptor() ([]byte, []int) { return fileDescriptorApi, []int{8} }
...
func init() {
	...
	proto.RegisterType((*SimpleSecret)(nil), "apipb.SimpleSecret")
...
func (c *aPIClient) CreateSecret(ctx context.Context, in *CreateSecretRequest, opts ...grpc.CallOption) (*SimpleSecret, error) {
	out := new(SimpleSecret)
...
func (c *aPIClient) GetSecret(ctx context.Context, in *GetSecretRequest, opts ...grpc.CallOption) (*SimpleSecret, error) {
	out := new(SimpleSecret)
...
type APIServer interface {
	CreateSecret(context.Context, *CreateSecretRequest) (*SimpleSecret, error)
	GetSecret(context.Context, *GetSecretRequest) (*SimpleSecret, error)
...
func (m *PrivateShare) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Content != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Content.Size()))
		n7, err := m.Content.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
	...
	if m.Hash != nil {
		...
		i++
		i = encodeVarintApi(dAtA, i, uint64(m.Hash.Size()))
		n9, err := m.Hash.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *CreateSecretRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CipherText != nil {
		...
		n10, err := m.CipherText.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
	...
	if m.Shares != nil {
		...
		n11, err := m.Shares.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
...
func (m *SimpleSecret) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SimpleSecret: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SimpleSecret: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorApi = []byte{
	...
	,
}
